<header id="header" class="header d-flex align-items-center fixed-top">
  <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        <li><a href="dashboard-director.html" class="active"><i class="bi bi-grid-fill me-1"></i> Dashboard</a></li>
        ...
        <li><a href="../tareas/tareas.html"><i class="bi bi-check2-square me-1"></i> Mis Tareas</a></li>
        <li><a href="#"><i class="bi bi-box-arrow-in-down me-1"></i> Entradas Inventario</a></li>
        <li class="dropdown">
