...
<body>
    ...
    <main class="main " style="margin-top: 70px;">
        ...
        <!-- Formulario Section -->
        <section id="formulario-insumo" class="section py-4">
            <div class="container" data-aos="fade-up" data-aos-delay="200">
                <div class="card shadow-sm">
                    <div class="card-header ">
                        <h5 class="mb-0 text-dark">Formulario de Insumo</h5>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="stock_min" class="form-control" required>
                                </div>
                            </div>
                            <div class="mt-4">
