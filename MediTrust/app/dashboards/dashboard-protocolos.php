...
<head>
    ...
    <title>Dashboard de protocolos - MediSoft</title>
...
<body class="index-page">
    ...
    <main class="main" style="margin-top: 80px;">
        ...
        <div class="container checklist-container">
            <h2 class="mb-4 text-center text-dark">Checklist Prequirúrgico</h2>
            ...
            <div class="estado-box">
                ...
                <ul class="list-group">
                    <li class="list-group-item">Cirugía - Septiembre 2023 <span class="badge bg-success float-end">Checklist completo</span></li>
